...
myTitleColor     = "#5577aa"  -- color of window title
...
myWorkspaces =
  [
    "1:Term",  "2:Ffox", "3:Mail",
    "4:Docs",  "5:Pass", "6:Misc",
    "7:Chat",  "8:Float", "9:Pix",
    "0:VM",    "Extr1", "Extr2"
  ]
...
defaultLayouts = smartBorders(avoidStruts(
  ...
  -- "super-l".
  windowNavigation (ResizableTall 1 (3/100) (3/5) [])

  -- Mirrored variation of ResizableTall. In this layout, the large
  -- master window is at the top, and remaining windows tile at the
  -- bottom of the screen. Can be resized as described above.
  -- ||| windowNavigation (Mirror (ResizableTall 1 (3/100) (2/3) []))
...
myKeyBindings =
  [
    ...
    -- Apps
    , ((myModMask, xK_f), spawn "firefox -ProfileManager --no-remote")
    , ((myModMask, xK_t), spawn "thunar")
    , ((myModMask, xK_r), spawn "roxterm")
    , ((myModMask, xK_v), spawn "gvim")
    , ((myModMask, xK_s), spawn "keepass2")
    , ((myModMask, xK_g), spawn "chromium-browser")
    , ((myModMask, xK_a), spawn "arandr")
    , ((myModMask, xK_b), spawn "abiword")
  ]

myMouseBindings =
  [
    ((myModMask, button1), (\w -> focus w >> Flex.mouseWindow Flex.resize w))
  ]
...
myManagementHooks = [
  ...
  , (className =? "keepass2") --> doF (W.shift "5:Pass")
  , (className =? "pavucontrol") --> doF (W.shift "6:Misc")
  ]
...
main = do
  xmproc <- spawnPipe "/home/eperez/.cabal/bin/xmobar /home/eperez/.xmobarrc"
